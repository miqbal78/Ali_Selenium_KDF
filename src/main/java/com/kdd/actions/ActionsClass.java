...
import com.kdd.pages.Ebay_HomePage;
import com.kdd.pages.Ebay_Registration;
...
import com.kdd.pages.Techlistic_Page;
...
public class ActionsClass implements GlobalVariables {
	...
	private Ebay_HomePage ObjhomePage = new Ebay_HomePage();

	private Ebay_Registration ObjReg = new Ebay_Registration();
	private Techlistic_Page ObjTechlistic = new Techlistic_Page();

	// ************************* Ebay Methods Start************************
	public void ClickShopCatagory(String data) {
		ObjhomePage.ClickshopByCatagory();
	}

	public void ClickToSignIn(String data) {
		ObjhomePage.ClickSignIn();
	}

	public void EnterEmailID(String data) {
		ObjhomePage.EnterEmail(data);
	}

	public void ClickToContinue(String data) {
		ObjhomePage.clickContinue();
	}

	public void ClickOnRegister(String data) {
		ObjhomePage.register();
	}

	/*
	 * public void EnterFirstName(String data) { ObjReg.EnterFirstName(data);
	 */
	/*
	 * } public void EnterLastName(String data) { ObjReg.EnterLastName(data); }
	 */
	public void EnterEmailId(String data) {
		ObjReg.EnterEmailId(data);
	}

	public void EnterPassword(String data) {
		ObjReg.EnterPassword(data);
	}

	public void ClickonCreateAccount(String data) {
		ObjReg.ClickCreateAccount();
	}

	public void GetEmailErrorText(String data) {
		String ErrorText = ObjReg.GetEmailErrorText();

		// Assert.assertEquals(originalTitle, expectedTitle);
		// Assert.assertEquals(ErrorText, data);

		if (ErrorText.equalsIgnoreCase(data)) {
			Log.info("Expected Message displayed : " + ErrorText);
		} else {
			Log.info("Expected Message did not displayed.");
			Assert.fail("Expected Message did not displayed.");
		}
	...
	// https://www.techlistic.com/p/selenium-practice-form.html?m=1--------------------

	public void ClickOnJava(String data) {
		ObjTechlistic.ClickJava();
	}

	public void EnterFirstName(String data) {
		ObjTechlistic.EnterFirstName(data);

	}

	public void EnterLastName(String data) {
		ObjTechlistic.EnterLastName(data);
	}

	public void SelectGender(String data) {
		ObjTechlistic.SelectGender();
	}

	public void SelectYearOfExperience(String data) {
		ObjTechlistic.SelectYearOfExperienc();
	}

	public void EnterDate(String data) {
		ObjTechlistic.Enterdate(data);
	}

	public void SelectProfession(String data) {
		ObjTechlistic.SelectProfession();
	}

	public void SelectAutomationTool(String data) {
		ObjTechlistic.SelectAutomationTools();

	}

	public void SelectContinentsDropdown(String data) {
	...
	public void selectPetByID(String data) {
		...
		assertEquals(SessionDataManager.getInstance().getSessionData("petDescription"),
				productsPage.getPetPDPDescritpion(), "Pet Description did not match on PDP");
	}

	public void addToCart(String data) {
		productsPage.clickAddToCartButton();
		assertEquals(SessionDataManager.getInstance().getSessionData("petDescription"),
				productsPage.getPetCartDescritpion(), "Pet Description did not match on Cart");
	}
